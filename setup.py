...
URL = "https://github.com/tped/skill-tped-meepi-intents"
SKILL_CLAZZ = "MeePiIntents"  # needs to match __init__.py class name
PYPI_NAME = "skill-tped-meepi-intents"  # pip install PYPI_NAME
